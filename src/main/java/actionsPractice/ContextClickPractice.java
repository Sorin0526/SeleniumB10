...
public class ContextClickPractice {
    ...
    public void test (){
        ...
        actions.contextClick(box).perform(); // perform is like submit button
    ...
    public void  hoverOver(){
        ...
        //Task find the xpath from all usernames
        ...
        for (int i = 0; i <names.size() ; i++) {
            ...
            actualNames.add(Browsers_Utils.getText(names.get(i)));
           // System.out.println(names.get(i).getText()); or
           // System.out.println(Browsers_Utils.getText(names.get(i)));
        }
